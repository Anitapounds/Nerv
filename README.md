...
NEXT_PUBLIC_REGISTRY_ID=your_registry_object_id_here
...
|----------|-------------|----------|
| `NEXT_PUBLIC_PACKAGE_ID` | Move package ID of deployed contract | Yes |
| `NEXT_PUBLIC_REGISTRY_ID` | GameRegistry shared object ID | Yes |
| `NEXT_PUBLIC_CLOCK_ID` | Clock object ID (default: 0x6) | No |
